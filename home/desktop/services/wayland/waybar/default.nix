...
in {
  ...
  xdg.configFile."waybar/config".text = import ./catppuccin.nix;
  xdg.configFile."waybar/style.css".text = import ./catppuccin-style.nix;
  xdg.configFile."waybar/macchiato.css".text = import ./catppuccin-macchiato.nix;
  programs.waybar = {
    enable = true;
